<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
            <img class="navbar-brand-logo" src="<?= $directoryAsset ?>/base/assets/images/logo.png" title="Remark">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                                        ...
                                        <ul class="blocks-3">
                                            <li>
                                                <a class="thumbnail margin-0" href="javascript:void(0)">
                                                    <img class="width-full" src="<?= $directoryAsset ?>/global/photos/placeholder.png" alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                                <a class="thumbnail margin-0" href="javascript:void(0)">
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
              ...
              <span class="avatar avatar-online">
                <img src="<?= $directoryAsset ?>/global/portraits/5.jpg" alt="...">
                <i></i>
              </span>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
                        ...
                        <li class="list-group" role="presentation">
                          ...
                          <span class="avatar avatar-sm avatar-online">
                            <img src="<?= $directoryAsset ?>/global/portraits/2.jpg" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-off">
                            <img src="<?= $directoryAsset ?>/global/portraits/3.jpg" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="<?= $directoryAsset ?>/global/portraits/4.jpg" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
